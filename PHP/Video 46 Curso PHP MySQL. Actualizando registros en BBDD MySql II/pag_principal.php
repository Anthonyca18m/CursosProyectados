	...
	<table class="table table-hover" id="registros">
	  <thead>
	    <tr>
	      ...
	      <th scope="col">
	      	<button type="button" class="btn btn-success btn-sm" id="btn_reg_art">Add</button>
	      </th>
	    </tr>
	  </thead>
	 ...
	 ?>
	    <tr>
	      ...
	      <td>
			<a href="update_articulo.php?cod=<?php echo $cod;?>">
				<button type="button" class="btn btn-primary btn-sm" id="btn_update_art">Edit</button>
			</a>
			<a href="delete.php?cod=<?php echo $cod;?>">
				<button name="btn_eliminar" id="btn_eliminar" class="btn btn-danger btn-sm" >x</button>
			</a>
	      </td>
	    </tr>
	<?php 
